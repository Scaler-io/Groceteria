...
namespace Swagger.Examples.UpdateOrder
{
    public class UpdateOrderRequestExample : IExamplesProvider<UpdateOrderRequest>
    {
        public UpdateOrderRequest GetExamples()
        {
